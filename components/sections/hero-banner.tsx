        ...
        <div className="lg:w-1/2">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <span className="bg-orange-100 text-orange-600 text-sm font-medium px-4 py-1.5 rounded-full">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-xl mb-6">
              Une agence réunissant un consortium d'experts africains dans les
              métiers du digital. Nous sommes spécialisés en communication
              digitale ainsi qu'en conception et développement de solutions
              numériques.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              <Link
                href="#contact"
                className="bg-gradient-to-r from-orange-500 to-red-500 text-white font-medium px-8 py-4 rounded-full flex items-center gap-2 hover:shadow-lg hover:shadow-orange-200/40 transition-all"
              >
              ...
              <Link
                href="#services"
                className="bg-white text-gray-800 font-medium px-8 py-4 rounded-full border border-gray-200 hover:border-orange-300 hover:shadow-md transition-all"
              >
                Nos services
              </Link>
            </div>
          ...
          >
            {services.map((service, index) => (
              ...
              >
                <div
                  className={`bg-gradient-to-r ${service.color} p-2 rounded-lg text-white`}
                >
                  {service.icon}
                </div>
