...
import { z } from "zod";
import { ArrowRight, Check, CheckCircle2, Send, X } from "lucide-react";
...
export function ContactForm() {
  ...
  const [selectedOffre, setSelectedOffre] = useState<SelectedOffreData | null>(null);
    ...
    try {
      ...
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: apiKey,
          from_name: "Site ADC",
          subject: `Nouvelle demande de contact ${data.offreName ? "pour " + data.offreName : ""}`,
          ...data
        })
      });
  ...
  return (
    <section id="contact" className="relative py-24 overflow-hidden bg-gradient-to-b from-white to-orange-50">
      {/* Éléments décoratifs */}
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="font-medium uppercase text-xl">Contactez-nous            </span>
          </motion.div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+225   27 32 797 538 /05 95 459 843 </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@africandigit-consulting.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Netzify Coworking, Rue L158, Angré, Abidjan</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-2xl shadow-lg p-8">
                ...
                {selectedOffre && !loadingOffre && (
                  <div className="mb-6 bg-orange-50 rounded-xl p-4 relative">
                    ...
                    <h4 className="font-medium text-gray-800 mb-2">Offre sélectionnée:</h4>
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="text-orange-600 font-medium">{selectedOffre.title}</p>
                        <p className="text-sm text-gray-600">{selectedOffre.type}</p>
                      </div>
                      <div className="font-bold text-gray-800">{selectedOffre.price}</div>
                    </div>
