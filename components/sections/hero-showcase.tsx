  ...
  const services = [
    {
      ...
      description:
        "Sites vitrines, e-commerce, applications web sur mesure adaptés à vos besoins",
    ...
    },
    {
      ...
      description:
        "Gestion des réseaux sociaux, création de contenu et stratégie d'engagement",
    ...
    },
    {
      ...
      description:
        "Création d'identité visuelle, logos, flyers et supports de communication",
    ...
    },
    {
      ...
      description:
        "Stratégies digitales, référencement SEO et campagnes publicitaires",
        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-6">
                <div
                  className={`bg-gradient-to-r ${service.color} w-12 h-12 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
                  {service.icon}
                </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                {[
                  ...
                  <div
                    key={index}
                    className="text-center p-3 bg-white/80 rounded-lg shadow-sm"
                  >
