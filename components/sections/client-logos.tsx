...
export function ClientLogos() {
  ...
  const displayCount = useTransform(rounded, (latest) => latest % clients.length);
    ...
    <section className="relative py-32 overflow-hidden bg-gradient-to-b from-orange-50 via-orange-100 to-amber-100">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center mb-24">
          ...
          >
            Découvrez les entreprises qui ont choisi notre expertise pour leur transformation digitale
          </motion.p>
        </div>
              ...
              {clients.map((client, index) => (
                <motion.div
                  ...
                  style={{
                    ...
                    willChange: Math.abs(index - currentIndex) < 2 ? "transform, opacity" : "auto"
                  }}
                ...
                >
                  <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-8 h-full flex flex-col items-center justify-center border border-orange-200 overflow-hidden group relative hover:border-orange-500 transition-all duration-300 shadow-xl">
                    ...
                    <h3 className="text-xl font-bold text-orange-900 mb-2 mt-4">{client.name}</h3>
                    <p className="text-orange-700 text-sm bg-orange-50 px-3 py-1 rounded-full border border-orange-200">{client.industry}</p>
