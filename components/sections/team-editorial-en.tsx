...
const team: Member[] = [
  ...
  },
  {
    ...
    role: "General manager · Digital transformation",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 mb-20 md:mb-24 items-end">
          <div className="lg:col-span-7">
            ...
            >
              Ten experts.{" "}
              <em className="text-orange-500 font-normal">One compass.</em>
            </m.h2>
          </div>
          ...
          >
            <p className="text-lg text-neutral-600 leading-relaxed">
              Developers, strategists, project leads. A young team based in
              Sud-Comoé, convinced the most useful technology is the one that
              stays simple.
            </p>
          </m.div>
        </div>
