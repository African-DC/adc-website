          ...
          <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="p-8 md:p-10 flex flex-col gap-7 h-full">
                ...
                <div>
                  <p className="text-xl md:text-2xl italic font-light text-neutral-700 leading-snug mb-3">
                    The AI assistant that welcomes the Ivorian diaspora.
                  </p>
                  <p className="text-sm text-neutral-500 leading-relaxed">
                    Consular procedures and investment. On the Web and WhatsApp, in French and local languages.
                  </p>
                </div>
                ...
                >
                  <div className="flex justify-end">
                    <div className="max-w-[85%] rounded-2xl rounded-tr-sm bg-white border border-neutral-200 px-3.5 py-2 text-[13px] text-neutral-700">
                      How do I renew my passport from Paris?
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="max-w-[85%] rounded-2xl rounded-tl-sm px-3.5 py-2 text-[13px] text-white" style={{ background: "#E8590C" }}>
                      Akwaba. Here are the documents to prepare and your consulate.
                    </div>
                  </div>
                  <div className="flex justify-end">
                    <div className="max-w-[85%] rounded-2xl rounded-tr-sm bg-white border border-neutral-200 px-3.5 py-2 text-[13px] text-neutral-700">
                      An agent wants a Mobile Money payment, is that legit?
                    </div>
                  </div>
                </div>

                <div className="flex items-center justify-between pt-4 border-t border-neutral-100 text-sm">
                  <span className="text-neutral-500">Diaspora · AI · Web & WhatsApp</span>
            ...
            >
              <div className="p-8 md:p-10 flex flex-col gap-7 h-full">
                ...
                <div>
                  <p className="text-xl md:text-2xl italic font-light text-neutral-700 leading-snug mb-3">
                    The voice-first interface making agricultural and climate expertise accessible.
                  </p>
                  <p className="text-sm text-neutral-500 leading-relaxed">
                    Voice or text questions, validated sources and traceable answers across multiple channels.
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-neutral-100 text-sm">
                  <span className="text-neutral-500">Agritech · Climate-tech · Multichannel</span>
                  <span className="inline-flex items-center gap-2 font-medium text-neutral-900 transition-colors">
                    Case study
                    <ArrowUpRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1" />
                  </span>
