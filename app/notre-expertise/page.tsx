...
import { CheckCircle, ArrowRight, Star, Code, Smartphone, BarChart, Users, PenTool } from "lucide-react";
...
const expertises = [
  {
    ...
    description: "Nous concevons et développons des sites web sur mesure, alliant esthétique et performance pour renforcer votre présence en ligne.",
  ...
  },
  {
    ...
    description: "Nous créons des identités visuelles mémorables et des designs impactants qui reflètent l'essence de votre marque et captivent votre audience.",
  ...
  },
  {
    ...
    description: "Nous élaborons des stratégies marketing digitales complètes pour accroître votre visibilité en ligne et générer des leads qualifiés.",
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              >
                ...
                <span className="text-orange-600 font-medium">NOTRE SAVOIR-FAIRE</span>
                <span className="h-px w-8 bg-orange-300"></span>
                <Star className="h-6 w-6 text-orange-500" />
              </motion.div>
              ...
              >
                Chez African Digit Consulting, nous réunissons une équipe pluridisciplinaire d'experts passionnés, 
                chacun apportant son expertise unique pour offrir des solutions digitales complètes et sur mesure. 
                Notre approche collaborative et notre vision panafricaine nous permettent de comprendre vos enjeux
                spécifiques et d'y répondre avec des solutions innovantes et adaptées.
              </motion.p>
            </div>
            ...
            >
              ...
              <div className="bg-white rounded-lg p-6 shadow-md border border-orange-100">
                ...
                <div className="text-gray-600 font-medium">Experts en digital</div>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section ref={containerRef} className="py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              >
                Découvrez nos compétences clés et comment nous pouvons transformer votre présence digitale.
              </motion.p>
            </div>
            ...
            <div className="space-y-32">
              {expertises.map((expertise, index) => (
                <section 
                  key={expertise.id} 
                  id={expertise.id} 
                  className={`py-20 ${index % 2 === 0 ? 'bg-white' : 'bg-gradient-to-b from-orange-50 to-white'}`}
                >
                  <div className="max-w-7xl mx-auto px-4">
                    <motion.div
                      initial={{ opacity: 0, y: 30 }}
                          ...
                          {expertise.categories.map((category) => (
                            <div key={category.name}>
                              <div className="flex justify-between mb-1">
                                ...
                                <span className="text-orange-600 font-medium">{category.percentage}%</span>
                              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              >
                ...
                <span className="font-medium uppercase text-xl">Nos réalisations web</span>
              </motion.div>
              ...
              >
                Des solutions web sur mesure conçues pour nos clients, alliant design moderne,
                expérience utilisateur optimale et performance technique.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              >
                <div className="relative h-[300px] overflow-hidden rounded-xl shadow-lg mb-4">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                    <h3 className="text-xl font-bold text-white mb-2">Plateforme B2B Complète</h3>
                    <p className="text-white/90">Solution e-commerce B2B avec catalogue produits, gestion des commandes et espace client sécurisé.</p>
                    <div className="mt-4 flex gap-2">
                      <span className="text-xs bg-orange-600/80 text-white px-3 py-1 rounded-full">React</span>
                      <span className="text-xs bg-orange-600/80 text-white px-3 py-1 rounded-full">Node.js</span>
                      <span className="text-xs bg-orange-600/80 text-white px-3 py-1 rounded-full">MongoDB</span>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-gray-600">Application web de commerce inter-entreprises</p>
              </motion.div>
              ...
              >
                <div className="relative h-[300px] overflow-hidden rounded-xl shadow-lg mb-4">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-orange-900/80 via-orange-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                    <h3 className="text-xl font-bold text-white mb-2">Site Vitrine ADS</h3>
                    <p className="text-white/90">Site vitrine moderne avec animations fluides et design responsive adapté à tous les appareils.</p>
                    <div className="mt-4 flex gap-2">
                      <span className="text-xs bg-orange-600/80 text-white px-3 py-1 rounded-full">Next.js</span>
                      <span className="text-xs bg-orange-600/80 text-white px-3 py-1 rounded-full">Tailwind CSS</span>
                      <span className="text-xs bg-orange-600/80 text-white px-3 py-1 rounded-full">Framer Motion</span>
                    </div>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-gray-800 group-hover:text-orange-700 transition-colors">
                ...
                <p className="text-gray-600">Site vitrine moderne avec expérience utilisateur optimisée</p>
              </motion.div>
            </div>
