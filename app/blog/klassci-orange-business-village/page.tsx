      ...
      <main className="overflow-hidden bg-white">
          ...
          <div className="max-w-3xl mx-auto px-6 space-y-8 text-neutral-800 text-lg leading-relaxed">
            ...
            <div className="my-10 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-xl border border-neutral-200 p-5 bg-neutral-50">
                <div
                  style={{ fontFamily: "var(--font-fraunces)" }}
                  className="text-4xl font-semibold text-neutral-950 mb-2"
                >
                  95 %
                </div>
            ...
            <blockquote
              style={{ fontFamily: "var(--font-fraunces)" }}
              className="my-12 border-l-2 border-orange-500 pl-6 md:pl-8 italic text-2xl md:text-3xl font-light text-neutral-900 leading-snug"
            >
        ...
        <section className="py-20 md:py-28 border-t border-neutral-200">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              Vous dirigez une université, une grande école, un lycée ?
            </h2>
            <p className="text-neutral-600 leading-relaxed mb-10 max-w-2xl mx-auto">
              Parlons de votre scolarité, de vos paiements, de vos
              bulletins. KLASSCI est peut-être la bonne conversation.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
              <Button asChild variant="cta" size="cta">
                <Link href="/nos-realisations/klassci">
                  <span>Découvrir KLASSCI</span>
